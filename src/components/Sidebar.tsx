...
export const Sidebar = () => {
  ...
  return (
    <aside className="flex w-56 flex-col select-none pt-2">
      ...
      >
        <div className="flex size-6 lg:size-7 items-center justify-center rounded-lg overflow-hidden">
          <img src={logoImage} alt="Koios" className="size-6 lg:size-7 object-contain" />
        </div>
