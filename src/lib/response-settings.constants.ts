...
export const LANGUAGES: LanguageOption[] = [
  {
    ...
    name: "Auto-detect",
    flag: "🌐",
    prompt: "IMPORTANT: Detect the language of the user's query and respond in the same language. If the user writes in French, respond in French. If they write in Spanish, respond in Spanish. Always match the language of your response to the language used in the question.",
  },
  {
    id: "english",
    name: "English",
